...
.divNorth{
	background:url('${pageContext.request.contextPath}/image/TitleBackground.jpg') no-repeat center center;
...
<body class="easyui-layout">
				...
				<td valign="top">
					<div style="position:relative;">
						<div style="text-align:right;font-size:15px;margin:2px 0 0 0;">
							...
							<span style="color:#c1dff7;">${activeUser.role.roleName}:</span>
	...
	<div id="HomeFuncAccordion" class="easyui-accordion" style="width:213px;"
		...
		<c:if test="${activeUser.role.roleName == '超级管理员' }">
