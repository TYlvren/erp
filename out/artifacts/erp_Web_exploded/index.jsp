...
<script type="text/javascript" src="WEB-INF/js/jquery.easyui.min.js"></script>

<script type="text/javascript" src="WEB-INF/js/common.js"></script>

<script type="text/javascript" src="WEB-INF/js/datagrid-filter.js"></script>

<script type="text/javascript" src="WEB-INF/js/jquery-easyui-1.4.1/locale/easyui-lang-zh_CN.js"></script>
<html>
<head>
    ...
    <link rel="stylesheet" type="text/css" href="WEB-INF/css/login/style.css"/>
    <style type="text/css">
        .download {
...
<script type="text/javascript" src="WEB-INF/js/login/placeholder.js"></script>
<script type="text/javascript">
    ...
    function randomcode_refresh() {
        $("#randomcode_img").attr('src',
            '/erp/validatecode.jsp?time' + new Date().getTime());
    }
</script>
<!--[if IE 6]>
<script type="text/javascript" src="WEB-INF/js/login/belatedpng.js"></script>
<script type="text/javascript">
    DD_belatedPNG.fix("*");
</script>
<![endif]--></body>
